...
namespace ChessEngine
{
    public partial class Position
    {
        ...
        public void EnPassantBB() {
            occupiedBB ^= (ulong)1 << EnPassantTarget;
            emptyBB |= (ulong)1 << EnPassantTarget;
        }
    }
    ...
    public class Bitboards {
        ...
        public static ulong MaskLine(int pos1, int pos2, out bool NotInLine) { //Line doesn't include pos1 and pos 2
            NotInLine = false;
